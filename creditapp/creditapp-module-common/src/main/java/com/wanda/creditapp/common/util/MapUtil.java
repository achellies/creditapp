...
public class MapUtil extends MapUtils {
	...
	public static Map<String, Object> castMapByObject(Object object) {
		...
		String jsonStr = JsonUtil.buildNormalBinder().toJson(object);
		remap = (Map<String, Object>) JsonUtil.buildNormalBinder().getJsonToMap(jsonStr, String.class, Object.class);
		return remap;
	}
	...
	public static Map<String, String> castMap(Object object) {
		...
		String jsonStr = JsonUtil.buildNormalBinder().toJson(object);
		remap = (Map<String, String>) JsonUtil.buildNormalBinder().getJsonToMap(jsonStr, String.class, String.class);
		return remap;
	}
}
