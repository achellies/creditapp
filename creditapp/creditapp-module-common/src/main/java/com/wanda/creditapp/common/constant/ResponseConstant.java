...
public enum ResponseConstant {
	...
	RESPONSE_SUCCESS("00000","处理成功",1,CommonConstant.RESPONSE_SUCCESS_CODE),
	RESPONSE_FAIL("10000","处理失败",1,CommonConstant.RESPONSE_FAIL_CODE),
	RESPONSE_ERRORCODE_UNKNOWNERROR("9999","未知错误",1,CommonConstant.RESPONSE_FAIL_CODE),
	...
	RESPONSE_REPEAT_REQUEST("3006","重复的请求",1,CommonConstant.RESPONSE_FAIL_CODE),
	
	
	RESPONSE_ACCESSTOKEN_INVALID("5001","session过期,请使用refreshToken更新",1,CommonConstant.RESPONSE_FAIL_CODE),
