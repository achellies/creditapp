 ...
 *
 */
@Service(ProductConstant.productPCB005Service)
public class ProductPCB005ServiceImpl extends AbstractProductService{
	...
	private final String prod_id = "P_C_B005";
	
	private final String inf_id = "P_C_B005";
